...
About the example on github, the U250 card is implemented for the experiment, while we use U50 in this class. There is one kernel function, “vector-add kernel”, and it 
